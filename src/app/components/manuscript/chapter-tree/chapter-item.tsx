// Enhanced chapter-item.tsx with Add Scene functionality
          ...
          {chapter.scenes
            ...
            .map((scene) => (
              <SceneItem
                key={scene.id}
                scene={scene}
                onSelect={() => onSceneSelect(scene.id, scene)} // ✨ FIXED: Match expected interface
                onDelete={() => onSceneDelete(scene.id)} // ✨ FIXED: Match expected interface
                isSelected={selectedSceneId === scene.id}
              />
            ))}

          {/* ✨ NEW: Add Scene at End Button */}
