...
// ✨ UPDATED: Smaller icons, buttons, and text sizes
...
import { useChapterNumbering } from "@/hooks/manuscript/useChapterNumbering";
...
> = ({
  ...
  // Use the chapter numbering hook
  ...
  return (
    <div
      ...
      `}
    >
      {/* ✨ SMALLER: Chapter Header with smaller icons and text */}
      <div
        className={`
          group py-1.5 px-2 rounded-md cursor-pointer transition-all
          ${
            isSelected
      ...
      >
        ...
        <div className="flex items-center space-x-1.5 mb-1.5">
          ...
          {/* Expand/Collapse Toggle - Smaller */}
          <button
            onClick={(e) => {
              e.stopPropagation();
              onToggle();
        ...
        {/* Line 2: Action buttons - Smaller */}
        <div className="flex items-center justify-between mb-1">
          <div className="flex items-center space-x-1">
            {/* Add Scene Button - Smaller */}
            {onAddScene && (
              <button
                onClick={(e) => {
                  e.stopPropagation();
          ...
          {onDeleteChapter && (
            <button
              ...
              className={`p-0.5 text-red-400 hover:text-red-300 hover:bg-red-900/30 rounded transition-all duration-200 ${
